...
def build_and_push(
    *,
    ...
    image_repo = os.environ.get("AZ_JINA_MCP_IMAGE_REPOSITORY_PREFIX", "az-jina-mcp")
...
def _registry_login_server(
    ...
    value = (
        override
        or os.environ.get("AZ_JINA_MCP_REGISTRY_LOGIN_SERVER")
    ...
    if not value or "<" in value or value.strip() == "":
        raise RuntimeError(
            ...
            "or export AZ_JINA_MCP_REGISTRY_LOGIN_SERVER."
        )
    return value
